...
function aplicandoEstilo() {
    for (let i = 0; i < $('#tblPacientesConsultorio1 > tbody')[0].children.length; i++) {

        if ($('#tblPacientesConsultorio1 > tbody')[0].children[i].children[1].outerText == '1') {
            $('#tblPacientesConsultorio1 > tbody')[0].children[i].children[1].innerHTML = "Normal";
            $('#tblPacientesConsultorio1 > tbody')[0].children[i].children[1].className = 'bg-info';

        } else if ($('#tblPacientesConsultorio1 > tbody')[0].children[i].children[1].outerText == '2') {
            $('#tblPacientesConsultorio1 > tbody')[0].children[i].children[1].innerHTML = "Alta";
            $('#tblPacientesConsultorio1 > tbody')[0].children[i].children[1].className = 'bg-warning';

        } else if ($('#tblPacientesConsultorio1 > tbody')[0].children[i].children[1].outerText == '3') {
            $('#tblPacientesConsultorio1 > tbody')[0].children[i].children[1].innerHTML = "Muito Alta";
            $('#tblPacientesConsultorio1 > tbody')[0].children[i].children[1].className = 'bg-danger';
        }
    };
    console.log($('#tblPacientesConsultorio1 > tbody')[0].children.length);
}
...
socket.on('consultorio1', (data) => {
    ...
    if (novaPrioridade.innerHTML == '1') {
        ...
        if (tableRow.find(a => a.children[1].outerText == "Muito Alta")) {
            ...
            $('#tblPacientesConsultorio1 > tbody').eq(0).prepend(novaLinha);
...
console.log($('#tblPacientesConsultorio1 > tbody')[0].children)

var form = null;
btnChamar.onclick = (x) => {
    console.log($('#tblPacientesConsultorio1')[0].children[1].children[0].children[2]);  
    if (tableRow.length > 0) {

        console.log($('#tblPacientesConsultorio1')[0].children[1].children[0].children[2].value);
        console.log($('#tblPacientesConsultorio1')[0].children[1]);
