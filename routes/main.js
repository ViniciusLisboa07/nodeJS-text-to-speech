...
router.post('/register', authMiddleware.isLogged, loginController.registerAction);
...
router.post('/eletro', authMiddleware.isLogged, eletroController.eletroAction);

// Rotas medicacao
router.get('/medicacao', authMiddleware.isLogged, medicacaoController.index);
router.post('/medicacao', authMiddleware.isLogged, medicacaoController.medicacaoAction);

// Rotas triagem 
router.get('/triagem', authMiddleware.isLogged, triagemController.index);
router.post('/triagem', authMiddleware.isLogged, triagemController.triagemAction);
